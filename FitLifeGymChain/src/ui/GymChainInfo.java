...
public class GymChainInfo {
    ...
    public static final String YOUR_GYM_NAME = "Bro Town";
    public static final String YOUR_MEMBER_NAME = "Samantha";
    ...
    private static void loadGyms(GymChain chain){
        ...
        Gym broGym = new Gym(YOUR_GYM_NAME);
        initializeGym0(broGym);
        chain.addGym(broGym);
    }


    private static void initializeGym0(Gym gym){
         Barbell bar = new Barbell(200);
